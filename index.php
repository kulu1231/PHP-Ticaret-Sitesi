        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form method="post" action="arama.php">
                                ...
                                <input type="text" placeholder="Neye ihtiyaç duydunuz?" name="search">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/alisveris-yapmak-1.jpg">
                        <div class="hero__text">
                            <span>Güvenli Alışveriş</span>
                            <h2 style="color:white">Ticaret <br />100% Memnuniyet</h2>
                            
                            <a href="#" class="primary-btn">Şimdi Satın Al</a>
                        </div>
                    </div>
                </div>
            </div>
